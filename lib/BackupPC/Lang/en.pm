...
<table class="tableStnd tbl-Admin_Options_Page-reload">
  <tr><td>Reload the server configuration:<td class="hasButtons"><input type="button" value="Reload"
...
<ul>
  <li><a href="\$MyURL\?action=editConfig">Edit Server Configuration</a></li>
  <li><a href="\$MyURL\?action=editConfig&newMenu=hosts">Edit Hosts</a></li>
</ul>
EOF
